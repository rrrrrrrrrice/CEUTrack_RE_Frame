...
class Fe108(BaseVideoDataset):
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        # frame_event_list = self._get_event_frame(seq_event_path, frame_ids) # voxel

        return frame_list, anno_frames, object_meta, None, frame_event_img_list     # frame_event_img_list
