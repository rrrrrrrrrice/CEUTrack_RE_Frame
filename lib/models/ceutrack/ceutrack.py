...
class CEUTrack(nn.Module):
    ...
    def forward_head(self, cat_feature, gt_score_map=None):
        ...
        #cat_feature就是搜索区域的x[event_x,rgb_x]  
        enc_opt1 = cat_feature[:, -self.feat_len_s:] #rgb_x
...
def build_ceutrack(cfg, training=True):
    ...
    pretrained_path = "/rydata/chenqiang/LLM_Tracking/LLM_Tracking_first_vision/pretrained_models"
